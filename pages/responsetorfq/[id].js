...
const RfqDetails = () => {
  ...
  const fetchRfqAndResponse = async () => {
    ...
    try {
      ...
      const supplierResponse = responseResponse.data.find(
        (res) => res.createdBy === userId
      ); // get the response of the current user
  ...
  const deleteResponse = async () => {
    ...
    if (!response) {
      setErrorMessage("No response to delete");
      return;
    }
    ...
    try {
      ...
      console.error(err);
      setErrorMessage("Error deleting response"); // set the error message
    }
  };
          ...
          <div className="edit-mode">
            <div>
              <label>
                ...
                <input
                  type="number"
                  name="unitPrice"
                  value={responseUpdates.unitPrice}
            ...
            <div>
              <label>
                ...
                <input
                  type="number"
                  name="investment"
                  value={responseUpdates.investment}
                  onChange={handleResponseInputChange}
                />
              </label>
            </div>
            <div>
              <label>
                ...
                <input
                  type="text"
                  name="currency"
                  value={responseUpdates.currency}
                  onChange={handleResponseInputChange}
                />
              </label>
            </div>
            <div>
              <label>
                ...
                <textarea
                  name="comments"
                  value={responseUpdates.comments}
                  onChange={handleResponseInputChange}
                />
              </label>
            </div>
            <div>
              ...
              {rfq.status && (
                <button
                  disabled={rfq.status === "Closed"}
                  onClick={toggleResponseEditMode}
                >
                  Cancel
                </button>
              )}
