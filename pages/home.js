...
function Home() {
    ...
    return (
        <div> {/*If the user is a 'buyer', this section will be displayed*/}
            {userType === 'buyer' && (
                <div>
                    <h1>Welcome, Buyer!</h1>
                    <p>Welcome to our RFQ management platform. You can create new RFQs, view outstanding RFQs and manage
                        responses from suppliers.</p>
                </div>
            )}
            ...
            {userType === 'supplier' && (
                <div>
                    ...
                    <p>Welcome to our RFQ management platform. You can view outstanding RFQs, submit responses and view statuses</p>
                </div>
            )}
        </div>
    );
